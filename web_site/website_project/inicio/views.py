...
from .models import Publicacion, Comentario, Like, PerfilUsuario, Usuario
...
def ver_perfil(request, usuario_id):
    ...
    """
    perfil = get_object_or_404(PerfilUsuario, usuario_id=usuario_id)  # Obtiene el perfil o lanza 404 si no existe
...
def editar_perfil(request):
    ...
    """
    perfil, created = PerfilUsuario.objects.get_or_create(usuario=request.user)  # Obtiene el perfil o lo crea si no existe
    if request.method == 'POST':
